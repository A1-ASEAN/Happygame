...
function Mission3() {
    ...
    const startTimer = () => {
        const countDownDate = new Date("Feb 15, 2023 17:50:00").getTime();
            ...
            <Stack direction="row"
                ...
                <Box>
                    <Stack direction="row"
                        ...
                        <Typography sx={{ mb: "0.5px", fontSize: '12px' }}>เหลือ{timerDay}วัน {timerHours}ชั่วโมง {timerMinutes}นาที </Typography>
                    </Stack>

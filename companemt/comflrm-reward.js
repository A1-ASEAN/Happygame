        ...
        <Box  sx={{  width: "100%", height: "100%", position: 'fixed', zIndex: "tooltip", top: 0, left: 0, right: 0 }}>
            ...
            <Box position={"fixed"} sx={{ top: "30%", right: "20%", zIndex: "tooltip", }} >
                <ThemeProvider theme={theme}>
                    ...
                    <Typography sx={{ pl:4.2, height: '100px', fontSize: 50 }} className={myFont.className} color={"primary"}>
                        THIS REDEEM?
                    </Typography>
                    ...
                    <Box sx={{ pl: 7, pt: 3 }}>
                            ...
                            <Button onClick={() => toggle(3)} variant="contained" color='error' sx={{ height: '54px', width: '186px', boxShadow: "inset 0 -0.9em 0 -0.35em rgba(0,0,0,0.17)" }} >

...
const Explain = ({ toggle, count, setcount }) => {
    ...
    return <Stack direction="row" justifyContent="center" alignItems="center">
        <Box sx={{ width: '100%', height: '130', position: 'fixed', bottom: "7.8%", bgcolor: '#f1f1f1', opacity: 0.95,boxShadow: " 0 0 5px #f1f1f1, 0 0 10px #f1f1f1" }}>
            <Stack direction="row"
...
const Explain3 = ({ toggle, count, setcount }) => {
    ...
    return <Stack direction="row" justifyContent="center" alignItems="center">
        <Box sx={{ width: '100%', height: '130', position: 'fixed', bottom: "7.8%", bgcolor: '#f1f1f1', opacity: 0.95,boxShadow: " 0 0 5px #f1f1f1, 0 0 10px #f1f1f1" }}>
                ...
                <Stack sx={{ opacity: 1 }} direction="row"
                    justifyContent="space-around"
                    alignItems="center">
                    <Box width={"244px"} height={"100%"}>
                        <Typography fontSize={"30px"} className={myFont.className}>
            ...
            <Grid container
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center" spacing={2}>
                        <Box onClick={() => toggle(1)} sx={{ width: { xs: "120px", }, height: '163px' }} >
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box onClick={() => toggle(2)} sx={{ width: { xs: "120px", }, height: '163px' }} >
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box>
                            <Box onClick={() => toggle(3)} sx={{ width: { xs: "120px", }, height: '163px' }}>
                ...
                <Grid item xs={4} sm={2}   >
                    <Stack alignItems="center">
                        <Box>
                            <Box onClick={() => toggle(4)} sx={{ width: { xs: "120px", }, height: '163px' }}>
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box>
                            <Box onClick={() => toggle(5)} sx={{ width: { xs: "120px", }, height: '163px' }}>
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box onClick={() => toggle(6)} sx={{ width: { xs: "120px", }, height: '163px' }}>
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box onClick={() => toggle(7)} sx={{ width: { xs: "120px", }, height: '163px' }}>
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box onClick={() => toggle(8)} sx={{ width: { xs: "120px", }, height: '163px' }} >
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box onClick={() => toggle(9)} sx={{ width: { xs: "120px", }, height: '163px' }} >
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box>
                            <Box onClick={() => toggle(10)} sx={{ width: { xs: "120px", }, height: '163px' }}>
                                <img src='/image/shop/10.svg' />
                            </Box>
                        </Box>
                    </Stack>
                </Grid>
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box>
                            <Box onClick={() => toggle(11)} sx={{ width: { xs: "120px", }, height: '163px' }}>
                                <img src='/image/shop/3.svg' />
                            </Box>
                        </Box>
                    </Stack>
                ...
                <Grid item xs={4} sm={2}  >
                    <Stack alignItems="center">
                        <Box>
                            <Box onClick={() => toggle(12)} sx={{ width: { xs: "120px", }, height: '163px' }}>
                                <img src='/image/shop/2.svg' />
                            </Box>
                        </Box>
                    </Stack>

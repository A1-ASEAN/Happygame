...
import Remain from '../companemt/recover-main'
...
export default function App() {
  ...
  const Coin = 50// variable have value random coin
  ...
  useEffect(() => {
    ...
    const animation = animate(count, Reward_vs_player, { duration: 1.5, delay: 8 });
    return () => {
      animation.stop
    }

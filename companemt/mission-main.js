                        ...
                        <Stack direction="row"
                            ...
                            <Box>
                                <Stack justifyContent="center"
                                    ...
                                    <Typography sx={{ fontSize: "30px", width: "100px", height: '20px', pr: 2 }} className={myFont.className}>
                                        REWARD
                                    </Typography>
                                </Stack>
                        ...
                        <Stack direction="row"
                            ...
                            <Box>
                                <Stack direction="row"
                                    ...
                                    spacing={2}>
                                    <Box sx={{ height: 17.7, width: 17.7 }}><img src='/image/mission/Clock.svg' /></Box>
                                    <Typography sx={{ fontSize: "12px", mb: "0.5px" }}>เหลือเวลา 5.00 นาที</Typography>
                                </Stack>
                                <Typography sx={{ fontSize: "15px" }}>
                        ...
                        <Stack direction="row"
                            ...
                            <Box>
                                <Stack direction="row"
                                    ...
                                    spacing={2}>
                                    <Box sx={{ height: 17.7, width: 17.7 }}><img src='/image/mission/Clock.svg' /></Box>
                                    <Typography sx={{ fontSize: "12px", mb: "0.5px" }}>เหลือเวลา 1 ชั่วโมง</Typography>
                                </Stack>
                                <Typography sx={{ fontSize: "15px" }}>
                                ...
                                <Stack direction="row"
                                    ...
                                    <Box sx={{ opacity: 0.2 }}>
                                        <Stack direction="row"
                                            ...
                                            alignItems="center"
                                            spacing={2}>
                                            <Box sx={{ height: 25, width: 17.7 }}><img src='/image/mission/skull-2.svg' /></Box>
                                            <Typography sx={{ fontSize: "12px", mb: "0.5px" }}>ภารกิจล้มเหลว</Typography>
                                        </Stack>
                                        <Typography sx={{ fontSize: "15px" }}>
                                            ภารกิจนี้ซ่อนอยู่ในตู้เย็น
                                        </Typography>

                                    </Box>
                                    <Box disabled sx={{ pr: 5.3}} >
                                        <img src='/image/mission/failed.svg' />
                                    </Box>
